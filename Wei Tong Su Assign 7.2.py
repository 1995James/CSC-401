...
deck = []
class Card:
    def __init__(self, cardsuit, cardrnk):
        if (cardsuit in suits) and (cardrnk in ranks):
            self.cardsuit = cardsuit
            self.cardrnk = cardrnk
        else:
            self.cardsuit = None
            self.cardrnk = None
            print("Invalid card: ", cardsuit, cardrnk)

    def __str__(self):
        return self.cardsuit + self.cardrnk

    def get_cardsuit(self):
        return self.cardsuit

    def get_cardrnk(self):
        return self.cardrnk

    def printt(self):
        print(self.cardrnk,self.cardsuit)
...
class Deck:
    def __init__(self):
        ...
        for cardsuit in suits:
            for cardrnk in ranks:
                self.cards.append(Card(cardsuit, cardrnk))
